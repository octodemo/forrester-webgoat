 ...
 */
 ...
 @RestController
 @AssignmentHints(
     value = {"SqlInjectionChallengeBasic4", "SqlInjectionChallengeBasic5", "SqlInjectionChallengeBasic6"})
 @Slf4j
 public class SqlInjectionChallengeBasic extends AssignmentEndpoint {
 
   private final LessonDataSource dataSource;
 
   public SqlInjectionChallengeBasic(LessonDataSource dataSource) {
